...
public class TokenInvalidException extends ApiErrorException {

    private static final long serialVersionUID = -3920604701837558957L;

    public TokenInvalidException(String token) {
        super(ErrorTypes.TOKEN_INVALID, token);
    }
}
