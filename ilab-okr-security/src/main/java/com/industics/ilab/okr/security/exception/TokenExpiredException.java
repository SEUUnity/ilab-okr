...
public class TokenExpiredException extends ApiErrorException {

    private static final long serialVersionUID = -4599782974551174269L;

    public TokenExpiredException(String token) {
        super(ErrorTypes.TOKEN_EXPIRED, token);
    }
}
